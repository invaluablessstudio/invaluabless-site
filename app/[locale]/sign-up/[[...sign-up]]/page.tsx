      ...
      >
        ...
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          ...
          <p className="mt-2 border-l-2 border-[#ff0040] pl-4 text-left text-sm leading-relaxed text-white/80">
            Create your beat maker account
          </p>
        </div>
              ...
              appearance={{
                ...
                elements: {
                  ...
                  socialButtonsBlockButton:
                    "border border-white/15 bg-white/[0.05] text-white hover:bg-white/[0.10] transition font-bold",
                  socialButtonsBlockButtonText: "text-white font-bold",
                  dividerLine: "bg-white/15",
                  dividerText:
                    "text-white/70 text-[10px] uppercase tracking-[0.2em]",
                  formFieldLabel:
                    "text-white font-bold uppercase tracking-[0.18em] text-[11px]",
                  formFieldInput:
                    "bg-black/50 border border-white/20 text-white placeholder:text-white/30 focus:border-[#ff0040]/60 outline-none transition rounded-none",
                  formButtonPrimary:
                  ...
                  footerActionLink:
                    "text-[#00f0ff] hover:text-cyan-200 font-bold",
                  ...
                  formFieldWarningText: "text-yellow-400 font-bold",
                  main: "gap-4",
                  form: "gap-4",
                },
              }}
