...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen text-white bg-[#0a0a0f]">
      ...
      {/* ================= THE PRODUCER ================= */}
      <section id="producer" className="py-20 relative z-20">
        <FadeInSection>
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6 text-gray-300 leading-relaxed">
                  <p>
                    Started in Puerto Rico in '09. Just speakers, hunger, and an
                    ear for low-end that had to translate everywhere — cars,
                    clubs, phone speakers. A few months later, what began as a
                    home setup turned into real sessions, real artists, and real
                    pressure.
                  </p>

                  <p>
                    2010: <strong className="text-white">La Caldera Records</strong>.
                    Built inside a barber shop in Quebradillas with my friend
                    Josue Tosado (MR KUSH). It wasn’t glamorous — but it worked.
                    Artists came in, records got made, and the sound kept
                    improving. Reggaeton, trap, rap, R&B, Latin — whatever
                    walked in, left different.
                  </p>
                  ...
                  <p>
                    ...
                    . San Juan was the next level. Real professional studios.
                    Real pressure. Sessions with{" "}
                    ...
                    <strong className="text-[#ff0040]">Bimbo El Oso Mañoso</strong>,
                    and many others. I earned my certification as a Recording
                    Engineer — but more importantly, I earned trust in the room.
                  </p>

                  <p>
                    <strong className="text-white">NOW</strong>: Now based in
                    San Antonio, I focus on one thing: making records that sound
                ...
                <div className="border-l-4 border-[#ff0040] pl-6 py-2">
                  <p className="text-lg font-bold italic text-white">
                    "Clean vocals. Heavy low end - If it don’t hit in the car at
                    night, it’s not done."
                  </p>
                </div>
      ...
      {/* ================= SELECTED CREDITS ================= */}
      <section id="credits" className="py-20 border-y border-white/5 relative z-20">
        <FadeInSection>
          <div className="max-w-7xl mx-auto px-6 md:px-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 text-sm text-gray-400 border-t border-white/10 pt-12">
              <div>
                ...
                <p className="leading-relaxed">
                  La Caldera Records (Quebradillas, PR) • Propiedad Urbana (San
                  Juan, PR) • Unstopable Studio (San Juan, PR) • Invaluabless
            ...
            <div className="mt-12 grid md:grid-cols-3 gap-6">
              <div className="p-8 border border-white/10 bg-white/[0.02] hover:border-[#ff0040]/50 transition-all group">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Vocals, instruments, full bands. Clean signal chain, pro
                  environment.
                </p>
              </div>
              <div className="p-8 border border-white/10 bg-white/[0.02] hover:border-[#00f0ff]/50 transition-all group">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Radio-ready, club-tested, headphone-approved. Your sound,
                  elevated.
                </p>
              </div>
              <div className="p-8 border border-white/10 bg-white/[0.02] hover:border-[#ff0040]/50 transition-all group">
                ...
                <p className="text-gray-400 text-sm leading-relaxed">
                  Original production. Reggaeton, trap, rap, Latin. Custom or
                  licensed.
                </p>
              </div>
            </div>
      ...
      {/* ================= CONTACT ================= */}
      {/* FIX: make section relative so the absolute gradient doesn't attach to <main> */}
